...
public class LocalApiController {
    ...
    public static class CapabilitiesDTO {
        ...
        public java.util.List<Integer> getSupportedResolutions() {
            return supportedResolutions;
        }

        public void setSupportedResolutions(java.util.List<Integer> supportedResolutions) {
        ...
        public void setSupportedFormats(java.util.List<String> supportedFormats) {
            this.supportedFormats = supportedFormats;
        }

        public java.util.List<String> getSupportedColorModes() {
            return supportedColorModes;
        }

        public void setSupportedColorModes(java.util.List<String> supportedColorModes) {
        ...
        public boolean isAdfSupported() {
            return adfSupported;
        }

        public void setAdfSupported(boolean adfSupported) {
            this.adfSupported = adfSupported;
        }
    }
}